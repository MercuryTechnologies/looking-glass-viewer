 ...
 */
import vertexShaderSource from "./edge.arrowHead.vert.glsl";
import fragmentShaderSource from "./edge.arrowHead.frag.glsl";
...
export default class ChonkyArrrowHeadProgram extends AbstractEdgeProgram {
    // Locations
